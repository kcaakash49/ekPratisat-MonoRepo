                ...
                <DialogContent onClose={() => setOpen(false)} className="max-w-xl">
                    ...
                    <form onSubmit={handleVerify} className="space-y-6 max-h-[60vh] overflow-y-auto pr-1">
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <input value={form.name} name="name" className="w-full px-3 py-2  border  border-secondary-300 dark:border-secondary-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-secondary-800 text-secondary-900 dark:text-secondary-100" placeholder="eg: Balen Shah" onChange={handleChange} />
                        </div>
                        ...
                        <div className="flex flex-col space-y-2">
                            ...
                            <input value={form.icon} type="text" name="icon" className="w-full px-3 py-2  border  border-secondary-300 dark:border-secondary-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent bg-white dark:bg-secondary-800 text-secondary-900 dark:text-secondary-100" placeholder="eg. balenshah@gmail.com" onChange={handleChange} />
                        </div>
