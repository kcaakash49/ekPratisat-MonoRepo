...
export default function UpdateBasicInfo({ leadId, name, email, coordinates, notes,status }: LeadProps) {
    ...
    const [newCoordinates, setNewCoordinates] = useState<string>(coordinates ? coordinates : "");
    ...
    const handleOpenDialog = () => {
        ...
        setNewCoordinates(coordinates ? coordinates : "")
